<header>
    <div class="up">
        <div class="content-up">
            <a href="{{ route('welcome') }}" class="logo">{{ __('words.logo') }}</a>
            <ul class="ul-up">
    ...
    <div class="down">
        <nav id="nav">
            <ul>
                ...
                <li><a href="#Campaigns">{{ __('words.campaigns') }}</a></li>
                <li><a href="#about-us">{{ __('words.about') }}</a></li>
                <li><a href="#contact us">{{ __('words.contact') }}</a></li>
